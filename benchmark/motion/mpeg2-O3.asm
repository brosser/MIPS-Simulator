...
main ()
{
 b30:	afb10040 	sw	s1,64(sp)
 b34:	afb0003c 	sw	s0,60(sp)
      v_r_size = 200;
      dmv = 0;
      mvscale = 1;
      for (i = 0; i < 2; i++)
	{
	  dmvector[i] = 0;
 b38:	afa00010 	sw	zero,16(sp)
 b3c:	afa00014 	sw	zero,20(sp)
  int dmvector[2];
  int motion_vertical_field_select[2][2];
  int s, motion_vector_count, mv_format, h_r_size, v_r_size, dmv, mvscale;
 ...
 b44:	af800000 	sw	zero,0(gp)
{
  ...
  ld_Bfr = 68157440;
  Flush_Buffer (0);		/* fills valid data into bfr */
 b48:	0c000000 	jal	0 <read>
 b4c:	af800000 	sw	zero,0(gp)
 b50:	8f910000 	lw	s1,0(gp)
{
  unsigned int Val;
 ...
 b54:	0c000000 	jal	0 <read>
 b58:	24040001 	li	a0,1
	    motion_vertical_field_select[0][s] = Get_Bits (1);
	}

      motion_vector (PMV[0][s], dmvector, h_r_size, v_r_size, dmv, mvscale,
 b5c:	27a40018 	addiu	a0,sp,24
 b60:	0c0000fc 	jal	3f0 <motion_vector.clone.1>
 b64:	27a50010 	addiu	a1,sp,16
		     0);

      /* update other motion vector predictors */
      PMV[1][s][0] = PMV[0][s][0];
 b68:	8fa30018 	lw	v1,24(sp)
      PMV[1][s][1] = PMV[0][s][1];
 b6c:	8fa2001c 	lw	v0,28(sp)
	for (j = 0; j < 2; j++)
	  {
	    main_result +=
 ...
 b70:	3864061e 	xori	a0,v1,0x61e
 b74:	385000ce 	xori	s0,v0,0xce
 b78:	8fa50020 	lw	a1,32(sp)
 b7c:	0004202b 	sltu	a0,zero,a0
 b80:	0010802b 	sltu	s0,zero,s0
 b84:	02048021 	addu	s0,s0,a0
 b88:	8fa40024 	lw	a0,36(sp)
 b8c:	38a50046 	xori	a1,a1,0x46
 b90:	0005282b 	sltu	a1,zero,a1
 b94:	00108040 	sll	s0,s0,0x1
 b98:	38840029 	xori	a0,a0,0x29
 b9c:	02058021 	addu	s0,s0,a1
 ba0:	0004202b 	sltu	a0,zero,a0
 ba4:	8fa50030 	lw	a1,48(sp)
		      mvscale);
	...
	for (j = 0; j < 2; j++)
	  {
	    main_result +=
 ba8:	02048021 	addu	s0,s0,a0
	      (motion_vertical_field_select[i][j] != outmvfs[i][j]);
	    for (k = 0; k < 2; k++)
	      main_result += (PMV[i][j][k] != outPMV[i][j][k]);
 bac:	8fa40034 	lw	a0,52(sp)
 bb0:	38a50078 	xori	a1,a1,0x78
 bb4:	0005282b 	sltu	a1,zero,a1
 bb8:	388400d8 	xori	a0,a0,0xd8
 bbc:	02058021 	addu	s0,s0,a1
 bc0:	0004202b 	sltu	a0,zero,a0
unsigned int
Show_Bits (N)
     int N;
{
 ...
 bc4:	00118fc2 	srl	s1,s1,0x1f
 bc8:	02048021 	addu	s0,s0,a0
 bcc:	00118840 	sll	s1,s1,0x1
 bd0:	02308021 	addu	s0,s1,s0
	  }

  
    printf ("%d\n", main_result);
 bd4:	3c040000 	lui	a0,0x0
 bd8:	02002821 	move	a1,s0
 bdc:	24840000 	addiu	a0,a0,0
      ...
      /* update other motion vector predictors */
      PMV[1][s][0] = PMV[0][s][0];
 be0:	afa30028 	sw	v1,40(sp)
 be4:	0c000000 	jal	0 <read>
 be8:	afa2002c 	sw	v0,44(sp)
  return main_result;

}
 bec:	8fbf0044 	lw	ra,68(sp)
 bf0:	02001021 	move	v0,s0
 bf4:	8fb10040 	lw	s1,64(sp)
 bf8:	8fb0003c 	lw	s0,60(sp)
 bfc:	03e00008 	jr	ra
 c00:	27bd0048 	addiu	sp,sp,72
