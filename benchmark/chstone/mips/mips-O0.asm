...
/**/
 ...
 75c:	00000000 	nop
 760:	3042ffff 	andi	v0,v0,0xffff
 764:	afc20044 	sw	v0,68(s8)
	      rt = (ins >> 16) & 0x1f;
 768:	8fc20018 	lw	v0,24(s8)
 76c:	00000000 	nop
 770:	00021402 	srl	v0,v0,0x10
 774:	3042001f 	andi	v0,v0,0x1f
 778:	afc2002c 	sw	v0,44(s8)
	      rs = (ins >> 21) & 0x1f;
 77c:	8fc20018 	lw	v0,24(s8)
 780:	00000000 	nop
 784:	00021542 	srl	v0,v0,0x15
 788:	3042001f 	andi	v0,v0,0x1f
 78c:	afc20030 	sw	v0,48(s8)

	      switch (op) {
 790:	8fc2001c 	lw	v0,28(s8)
 794:	00000000 	nop
 798:	2c42002c 	sltiu	v0,v0,44
 79c:	104000e2 	beqz	v0,b28 <main+0xb28>
 7a0:	00000000 	nop
 7a4:	8fc2001c 	lw	v0,28(s8)
 7a8:	00000000 	nop
 7ac:	00021880 	sll	v1,v0,0x2
 7b0:	3c020000 	lui	v0,0x0
 7b4:	244201a0 	addiu	v0,v0,416
 ...
 7cc:	8fc20030 	lw	v0,48(s8)
 7d0:	00000000 	nop
 7d4:	00021080 	sll	v0,v0,0x2
 7d8:	03c21021 	addu	v0,s8,v0
 7dc:	8c430048 	lw	v1,72(v0)
 7e0:	8fc20044 	lw	v0,68(s8)
 7e4:	00000000 	nop
 7e8:	00621821 	addu	v1,v1,v0
 7ec:	8fc2002c 	lw	v0,44(s8)
 7f0:	00000000 	nop
 7f4:	00021080 	sll	v0,v0,0x2
 7f8:	03c21021 	addu	v0,s8,v0
 7fc:	ac430048 	sw	v1,72(v0)
		        break;
 800:	080002cc 	j	b30 <main+0xb30>
 804:	00000000 	nop

		    case ANDI:
		        reg[rt] = reg[rs] & (unsigned int /*short*/) address;
 808:	8fc20030 	lw	v0,48(s8)
 80c:	00000000 	nop
 810:	00021080 	sll	v0,v0,0x2
 814:	03c21021 	addu	v0,s8,v0
 818:	8c420048 	lw	v0,72(v0)
 81c:	00000000 	nop
 820:	00401821 	move	v1,v0
 824:	8fc20044 	lw	v0,68(s8)
 828:	00000000 	nop
 82c:	00621024 	and	v0,v1,v0
 830:	00401821 	move	v1,v0
 834:	8fc2002c 	lw	v0,44(s8)
 838:	00000000 	nop
 83c:	00021080 	sll	v0,v0,0x2
 840:	03c21021 	addu	v0,s8,v0
 844:	ac430048 	sw	v1,72(v0)
		        break;
 848:	080002cc 	j	b30 <main+0xb30>
 84c:	00000000 	nop
		    case ORI:
		        reg[rt] = reg[rs] | (unsigned int /*short*/) address;
 850:	8fc20030 	lw	v0,48(s8)
 854:	00000000 	nop
 858:	00021080 	sll	v0,v0,0x2
 85c:	03c21021 	addu	v0,s8,v0
 860:	8c420048 	lw	v0,72(v0)
 864:	00000000 	nop
 868:	00401821 	move	v1,v0
 86c:	8fc20044 	lw	v0,68(s8)
 870:	00000000 	nop
 874:	00621025 	or	v0,v1,v0
 878:	00401821 	move	v1,v0
 87c:	8fc2002c 	lw	v0,44(s8)
 880:	00000000 	nop
 884:	00021080 	sll	v0,v0,0x2
 888:	03c21021 	addu	v0,s8,v0
 88c:	ac430048 	sw	v1,72(v0)
		        break;
 890:	080002cc 	j	b30 <main+0xb30>
 894:	00000000 	nop
		    case XORI:
		        reg[rt] = reg[rs] ^ (unsigned int /*short*/) address;
 898:	8fc20030 	lw	v0,48(s8)
 89c:	00000000 	nop
 8a0:	00021080 	sll	v0,v0,0x2
 8a4:	03c21021 	addu	v0,s8,v0
 8a8:	8c420048 	lw	v0,72(v0)
 8ac:	00000000 	nop
 8b0:	00401821 	move	v1,v0
 8b4:	8fc20044 	lw	v0,68(s8)
 8b8:	00000000 	nop
 8bc:	00621026 	xor	v0,v1,v0
 8c0:	00401821 	move	v1,v0
 8c4:	8fc2002c 	lw	v0,44(s8)
 8c8:	00000000 	nop
 8cc:	00021080 	sll	v0,v0,0x2
 8d0:	03c21021 	addu	v0,s8,v0
 8d4:	ac430048 	sw	v1,72(v0)
		        break;
 8d8:	080002cc 	j	b30 <main+0xb30>
 8dc:	00000000 	nop

		    case LW:
		        reg[rt] = dmem[DADDR (reg[rs] + address)];
 8e0:	8fc20030 	lw	v0,48(s8)
 8e4:	00000000 	nop
 8e8:	00021080 	sll	v0,v0,0x2
 8ec:	03c21021 	addu	v0,s8,v0
 8f0:	8c430048 	lw	v1,72(v0)
 8f4:	8fc20044 	lw	v0,68(s8)
 8f8:	00000000 	nop
 8fc:	00621021 	addu	v0,v1,v0
 900:	304200ff 	andi	v0,v0,0xff
 904:	00021083 	sra	v0,v0,0x2
 908:	00021080 	sll	v0,v0,0x2
 90c:	03c21021 	addu	v0,s8,v0
 910:	8c4300c8 	lw	v1,200(v0)
 914:	8fc2002c 	lw	v0,44(s8)
 918:	00000000 	nop
 91c:	00021080 	sll	v0,v0,0x2
 920:	03c21021 	addu	v0,s8,v0
 924:	ac430048 	sw	v1,72(v0)
		        break;
 928:	080002cc 	j	b30 <main+0xb30>
 92c:	00000000 	nop
		    case SW:
 ...
 944:	8fc20044 	lw	v0,68(s8)
 948:	00000000 	nop
 94c:	00621021 	addu	v0,v1,v0
 950:	304200ff 	andi	v0,v0,0xff
 954:	00022083 	sra	a0,v0,0x2
 958:	8fc2002c 	lw	v0,44(s8)
 95c:	00000000 	nop
 960:	00021080 	sll	v0,v0,0x2
 964:	03c21021 	addu	v0,s8,v0
 968:	8c430048 	lw	v1,72(v0)
 96c:	00041080 	sll	v0,a0,0x2
 970:	03c21021 	addu	v0,s8,v0
 974:	ac4300c8 	sw	v1,200(v0)
		        break;
 978:	080002cc 	j	b30 <main+0xb30>
 97c:	00000000 	nop

		    case LUI:
		        reg[rt] = address << 16;
 980:	8fc20044 	lw	v0,68(s8)
 984:	00000000 	nop
 988:	00021c00 	sll	v1,v0,0x10
 98c:	8fc2002c 	lw	v0,44(s8)
 990:	00000000 	nop
 994:	00021080 	sll	v0,v0,0x2
 998:	03c21021 	addu	v0,s8,v0
 99c:	ac430048 	sw	v1,72(v0)
		        break;
 9a0:	080002cc 	j	b30 <main+0xb30>
 9a4:	00000000 	nop

		    case BEQ:
		        if (reg[rs] == reg[rt])
 9a8:	8fc20030 	lw	v0,48(s8)
 9ac:	00000000 	nop
 9b0:	00021080 	sll	v0,v0,0x2
 9b4:	03c21021 	addu	v0,s8,v0
 9b8:	8c430048 	lw	v1,72(v0)
 9bc:	8fc2002c 	lw	v0,44(s8)
 9c0:	00000000 	nop
 9c4:	00021080 	sll	v0,v0,0x2
 9c8:	03c21021 	addu	v0,s8,v0
 9cc:	8c420048 	lw	v0,72(v0)
 9d0:	00000000 	nop
 9d4:	14620009 	bne	v1,v0,9fc <main+0x9fc>
 9d8:	00000000 	nop
		        pc = pc - 4 + (address << 2);
 9dc:	8fc20008 	lw	v0,8(s8)
 9e0:	00000000 	nop
 9e4:	2443fffc 	addiu	v1,v0,-4
 9e8:	8fc20044 	lw	v0,68(s8)
 9ec:	00000000 	nop
 9f0:	00021080 	sll	v0,v0,0x2
 9f4:	00621021 	addu	v0,v1,v0
 9f8:	afc20008 	sw	v0,8(s8)
		        break;
 9fc:	080002cc 	j	b30 <main+0xb30>
 a00:	00000000 	nop
		    case BNE:
		        if (reg[rs] != reg[rt])
 a04:	8fc20030 	lw	v0,48(s8)
 a08:	00000000 	nop
 a0c:	00021080 	sll	v0,v0,0x2
 a10:	03c21021 	addu	v0,s8,v0
 a14:	8c430048 	lw	v1,72(v0)
 a18:	8fc2002c 	lw	v0,44(s8)
 a1c:	00000000 	nop
 a20:	00021080 	sll	v0,v0,0x2
 a24:	03c21021 	addu	v0,s8,v0
 a28:	8c420048 	lw	v0,72(v0)
 a2c:	00000000 	nop
 a30:	10620009 	beq	v1,v0,a58 <main+0xa58>
 a34:	00000000 	nop
		        pc = pc - 4 + (address << 2);
 a38:	8fc20008 	lw	v0,8(s8)
 a3c:	00000000 	nop
 a40:	2443fffc 	addiu	v1,v0,-4
 a44:	8fc20044 	lw	v0,68(s8)
 a48:	00000000 	nop
 a4c:	00021080 	sll	v0,v0,0x2
 a50:	00621021 	addu	v0,v1,v0
 a54:	afc20008 	sw	v0,8(s8)
		        break;
 a58:	080002cc 	j	b30 <main+0xb30>
 a5c:	00000000 	nop
		    case BGEZ:
		        if (reg[rs] >= 0)
 a60:	8fc20030 	lw	v0,48(s8)
 a64:	00000000 	nop
 a68:	00021080 	sll	v0,v0,0x2
 a6c:	03c21021 	addu	v0,s8,v0
 a70:	8c420048 	lw	v0,72(v0)
 a74:	00000000 	nop
 a78:	04400009 	bltz	v0,aa0 <main+0xaa0>
 a7c:	00000000 	nop
		        pc = pc - 4 + (address << 2);
 a80:	8fc20008 	lw	v0,8(s8)
 a84:	00000000 	nop
 a88:	2443fffc 	addiu	v1,v0,-4
 a8c:	8fc20044 	lw	v0,68(s8)
 a90:	00000000 	nop
 a94:	00021080 	sll	v0,v0,0x2
 a98:	00621021 	addu	v0,v1,v0
 a9c:	afc20008 	sw	v0,8(s8)
		        break;
 aa0:	080002cc 	j	b30 <main+0xb30>
 aa4:	00000000 	nop

		    case SLTI:
		        reg[rt] = reg[rs] < address;
 aa8:	8fc20030 	lw	v0,48(s8)
 aac:	00000000 	nop
 ab0:	00021080 	sll	v0,v0,0x2
 ab4:	03c21021 	addu	v0,s8,v0
 ab8:	8c430048 	lw	v1,72(v0)
 abc:	8fc20044 	lw	v0,68(s8)
 ac0:	00000000 	nop
 ac4:	0062182a 	slt	v1,v1,v0
 ac8:	8fc2002c 	lw	v0,44(s8)
 acc:	00000000 	nop
 ad0:	00021080 	sll	v0,v0,0x2
 ad4:	03c21021 	addu	v0,s8,v0
 ad8:	ac430048 	sw	v1,72(v0)
		        break;
 adc:	080002cc 	j	b30 <main+0xb30>
 ae0:	00000000 	nop

		    case SLTIU:
 		        reg[rt] = (unsigned int) reg[rs] < (unsigned int /*short*/) address;
 ae4:	8fc20030 	lw	v0,48(s8)
 ae8:	00000000 	nop
 aec:	00021080 	sll	v0,v0,0x2
 af0:	03c21021 	addu	v0,s8,v0
 af4:	8c420048 	lw	v0,72(v0)
 af8:	00000000 	nop
 afc:	00401821 	move	v1,v0
 b00:	8fc20044 	lw	v0,68(s8)
 b04:	00000000 	nop
 b08:	0062182b 	sltu	v1,v1,v0
 b0c:	8fc2002c 	lw	v0,44(s8)
 b10:	00000000 	nop
 b14:	00021080 	sll	v0,v0,0x2
 b18:	03c21021 	addu	v0,s8,v0
 b1c:	ac430048 	sw	v1,72(v0)
		        break;
 b20:	080002cc 	j	b30 <main+0xb30>
 b24:	00000000 	nop

		    default:
		        pc = 0;	/* error */
 b28:	afc00008 	sw	zero,8(s8)
	...
		        break;
		    }
	        break;
        ...
        reg[0] = 0;
 b34:	afc00048 	sw	zero,72(s8)
	    n_inst = n_inst + 1;
 b38:	8fc20014 	lw	v0,20(s8)
 b3c:	00000000 	nop
 b40:	24420001 	addiu	v0,v0,1
 b44:	afc20014 	sw	v0,20(s8)
    } while (pc != 0);
 b48:	8fc20008 	lw	v0,8(s8)
 b4c:	00000000 	nop
 b50:	1440fd5f 	bnez	v0,d0 <main+0xd0>
 b54:	00000000 	nop

    main_result += (n_inst != 611);
 b58:	8fc20014 	lw	v0,20(s8)
 b5c:	00000000 	nop
 b60:	38420263 	xori	v0,v0,0x263
 b64:	0002182b 	sltu	v1,zero,v0
 b68:	8f820000 	lw	v0,0(gp)
 b6c:	00000000 	nop
 b70:	00621021 	addu	v0,v1,v0
 b74:	af820000 	sw	v0,0(gp)

    // Checker inside the c program
    // If the data stored in imem at the end of execution is not equal,
    // 1 instead of 0 is returned.
    for (j = 0; j < 8; j++)
 b78:	afc0000c 	sw	zero,12(s8)
 b7c:	080002f8 	j	be0 <main+0xbe0>
 b80:	00000000 	nop
	{
	    main_result += (dmem[j] != outData[j]);
 b84:	8fc2000c 	lw	v0,12(s8)
 b88:	00000000 	nop
 b8c:	00021080 	sll	v0,v0,0x2
 b90:	03c21021 	addu	v0,s8,v0
 b94:	8c4300c8 	lw	v1,200(v0)
 b98:	3c020000 	lui	v0,0x0
 b9c:	8fc4000c 	lw	a0,12(s8)
 ba0:	00000000 	nop
 ba4:	00042080 	sll	a0,a0,0x2
 ba8:	24420000 	addiu	v0,v0,0
 bac:	00821021 	addu	v0,a0,v0
 bb0:	8c420000 	lw	v0,0(v0)
 bb4:	00000000 	nop
 bb8:	00621026 	xor	v0,v1,v0
 bbc:	0002182b 	sltu	v1,zero,v0
 bc0:	8f820000 	lw	v0,0(gp)
 bc4:	00000000 	nop
 bc8:	00621021 	addu	v0,v1,v0
 bcc:	af820000 	sw	v0,0(gp)
    ...
    // 1 instead of 0 is returned.
    for (j = 0; j < 8; j++)
 bd0:	8fc2000c 	lw	v0,12(s8)
 bd4:	00000000 	nop
 bd8:	24420001 	addiu	v0,v0,1
 bdc:	afc2000c 	sw	v0,12(s8)
 be0:	8fc2000c 	lw	v0,12(s8)
 be4:	00000000 	nop
 be8:	28420008 	slti	v0,v0,8
 bec:	1440ffe5 	bnez	v0,b84 <main+0xb84>
 bf0:	00000000 	nop
	{
	    main_result += (dmem[j] != outData[j]);
	}
    ...
    return main_result;
 bf4:	8f820000 	lw	v0,0(gp)
  }
}
 bf8:	03c0e821 	move	sp,s8
 bfc:	8fbe01cc 	lw	s8,460(sp)
 c00:	27bd01d0 	addiu	sp,sp,464
 c04:	03e00008 	jr	ra
 c08:	00000000 	nop
...
000000d0 <outData>:
 ...
 1bc:	00000b28 	0xb28
 1c0:	00000b28 	0xb28
 1c4:	000007cc 	syscall	0x1f
 1c8:	00000aa8 	0xaa8
 1cc:	00000ae4 	0xae4
 1d0:	00000808 	0x808
 1d4:	00000850 	0x850
 1d8:	00000898 	0x898
 1dc:	00000980 	sll	at,zero,0x6
 1e0:	00000b28 	0xb28
 1e4:	00000b28 	0xb28
 1e8:	00000b28 	0xb28
 1ec:	00000b28 	0xb28
