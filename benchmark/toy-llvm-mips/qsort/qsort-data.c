...
// location of data here is going to generate a memory section called .data
int arr[10/*50*//*100*/] =  { 1176, 1112, 716, 720, 816, 970, 911, 846, 865, 800/*,
...
int main() {
	...
	int piv, L, R, swap;
    	int i = 0;
    	int beg[10/*50*//*100*/], end[10/*50*//*100*/];
    	int main_result = 0;


    //int counter = 0; 

    beg[0]=0; end[0]=10/*50*//*100*/;
