...
const int expected_quotient[N] = {15, 9, 35, 18};
const int expected_remainder[N] = {5, 3, 4, 3};
...
int main() {
	...
	if (quotient != expected_quotient[test] && remainder != expected_quotient[test]) {
		main_result += 1;
	}
    }
