...
mips-elf-objdump -D -S -j .rodata -j .text -j .bss -j .data fir.o > fir-O0.asm
...
mips-elf-objdump -D -S -j .rodata -j .text -j .bss -j .data fir.o > fir-O1.asm

mips-elf-gcc -O2 -c -g fir.c
mips-elf-objdump -D -S -j .rodata -j .text -j .bss -j .data fir.o > fir-O2.asm

mips-elf-gcc -O3 -c -g fir.c
mips-elf-objdump -D -S -j .rodata -j .text -j .bss -j .data fir.o > fir-O3.asm
